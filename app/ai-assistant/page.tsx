...
const TranscriptionCard = ({ meeting, onClick, isSelected }) => {
  // Formatear la fecha
    ...
    <div className="min-h-screen bg-blue-900">
      <main className="container mx-auto px-4 pb-24 pt-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-white mb-8 glow-text">Asistente IA</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              {sortedMeetings.length > 0 ? (
                ...
                <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-xl font-medium text-white mb-2">No hay transcripciones disponibles</h3>
