...
import { ACTIVE_MODEL, getModelDisplayName } from "@/utils/openai-config"
...
`,
    ...
    // Call the AI to generate a response using the AI SDK
    ...
    return NextResponse.json({
      response: text,
      model: getModelDisplayName(ACTIVE_MODEL),
    })
  } catch (error) {
